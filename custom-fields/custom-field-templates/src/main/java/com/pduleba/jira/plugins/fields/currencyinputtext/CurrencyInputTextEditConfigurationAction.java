...
@Slf4j
public class CurrencyInputTextEditConfigurationAction extends AbstractEditConfigurationItemAction {

	private static final long serialVersionUID = 816164801314288847L;

	public CurrencyInputTextEditConfigurationAction(ManagedConfigurationItemService managedConfigurationItemService) {
